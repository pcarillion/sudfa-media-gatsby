                ...
                <div className="column-evenly-center">
                    <div className={styles.firstArticleDiv}>
                        ...
                        <div className={styles.mainArticleContent}>
                            <AniLink paintDrip hex="black" duration={0.5} to={`/article/${articles.edges[0].node.slug}`}><h2 className={styles.mainArticleTitle}>{articles.edges[0].node.titre}</h2></AniLink>
                    ...
                    <div className={styles.mainArticlesDiv}>
                        <div className={styles.mainArticlesContent}>
                            <AniLink paintDrip hex="black" duration={0.5} to={`/article/${articles.edges[1].node.slug}`}><h3>{articles.edges[1].node.titre}</h3></AniLink>
                        ...
                        <div className={styles.mainArticlesContent}>
                            <AniLink paintDrip hex="black" duration={0.5} to={`/article/${articles.edges[2].node.slug}`}><h3>{articles.edges[2].node.titre}</h3></AniLink>
                        ...
                        <div className={styles.mainArticlesContent}>
                            <AniLink paintDrip hex="black" duration={0.5} to={`/article/${articles.edges[3].node.slug}`}><h3>{articles.edges[3].node.titre}</h3></AniLink>
                        ...
                        <div className={styles.mainArticlesContent}>
                            <AniLink paintDrip hex="black" duration={0.5} to={`/article/${articles.edges[4].node.slug}`}><h3>{articles.edges[4].node.titre}</h3></AniLink>
